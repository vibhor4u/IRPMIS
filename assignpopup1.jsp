									...
									<table id="dt-basic-example2" class="table table-bordered table-hover table-striped w-100">
										<thead class="bg-warning-200">
											<tr>
												...
												<th colspan="2">To</th>
												<th rowspan="2">Assign to User(s)</th>
											</tr>
										...
										<tbody>
											<tr>
												<td>1.</td>
												<td><input type="text" id="tpfrom" class="form-control" placeholder="" name="tpfrom" required size="5" maxlength="15"></td>
												<td><input type="text" id="tpfrom" class="form-control" placeholder="" name="tpfrom" required size="5" maxlength="15"></td>
												<td><input type="text" id="tpfrom" class="form-control" placeholder="" name="tpfrom" required size="5" maxlength="15"></td>
												<td><input type="text" id="tpfrom" class="form-control" placeholder="" name="tpfrom" required size="5" maxlength="15"></td>
												<td><input type="text" id="tpfrom" class="form-control" placeholder="" name="tpfrom" required size="5" maxlength="15"></td>
												<td><!-- <select class="select2 form-control" name="divcode" id="divcode" required data-parsley-trigger="blur" data-parsley-errors-container="#select-errors4"
													data-parsley-required-message="You must select one option.">
														...
														<option value="caonr">CE1/Con/NR</option>
														<option value="caocr">CE2/Con/NR</option>
														<option value="caocr">CEE2/Con/NR</option>
														<option value="caocr">CEE2/Con/NR</option>
														<option value="caocr">CSE1/Con/NR</option>
														<option value="caocr">CSE2/Con/NR</option>
												</select>  -->
												
												<select class="selectdropdown form-control" multiple="multiple" name="possiblesubstage" id="possiblesubstage" required data-parsley-trigger="blur"
													data-parsley-errors-container="#select-errors9" data-parsley-required-message="You must select one option.">
...
$(document).ready(function() {
	...
	$('.selectdropdown').select2({
		dropdownParent : $('#default-example-modal-lg-center')
	});
