...
<body class="mod-bg-1 ">
		...
		<div class="row">
			<div class="col-lg-12">
				<div id="panel-4" class="panel panel-locked" data-panel-sortable="" data-panel-collapsed="" data-panel-close="">
					<div class="panel-hdr">
						<h2>Project Assignment By Chief Engineer</h2>
					</div>
									...
									<tr>
										...
										<td class="text-center">
											<!-- <div class="dropdown d-inline-block dropleft">
															<a href='javascript:void(0);' class='btn btn-sm btn-icon btn-outline-success rounded-circle mr-1' title='Update Proposal'
																onclick=""> <span><i class="fal fa-pencil"></i></span>
															</a> <a href='javascript:void(0);' class='btn btn-sm btn-icon btn-outline-danger rounded-circle mr-1' title='Drop Proposal'
																onclick=""> <span><i class="fal fa-times"></i></span>
															</a>
														</div> -->
											<button type="button" class="btn btn-labeled btn-primary" id="assign" onclick="openPopUp();">Assign</button>
										</td>
									</tr>
							</table>
							<!-- datatable end -->
	...
	<script type="text/javascript">
		...
		function openPopUp() {
			...
			var pageurl = '${pageContext.request.contextPath}/assignpopup2.jsp';
