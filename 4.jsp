...
<body class="mod-bg-1 ">
		...
		<div class="row">
			<div class="col-lg-12">
				<div id="panel-4" class="panel panel-locked" data-panel-sortable="" data-panel-collapsed="" data-panel-close="">
					<div class="panel-hdr">
						<h2>Entry by Deputy Chief Engineer</h2>
					</div>
								...
								<tbody>
									<tr>
										...
										<td class="text-center">
											<button type="button" class="btn btn-labeled btn-primary" id="assign" onclick="openPopUp();">Basic Details</button>
											<button type="button" class="btn btn-labeled btn-primary" id="assign" onclick="openPopUp();">Block Section</button>
										</td>
									</tr>
							</table>
							<!-- datatable end -->
	...
	<script type="text/javascript">
		...
		function openPopUp1() {
			...
			var pageurl = '${pageContext.request.contextPath}/assignpopup3.jsp';
		...
		function openPopUp2() {
			...
			var pageurl = '${pageContext.request.contextPath}/assignpopup4.jsp';
			$.when($.get(pageurl, function(data) {
				$('#modalContainer').html(data);
			})).done(function() {
				$('#default-example-modal-lg-center').modal({
